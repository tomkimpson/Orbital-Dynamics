...
real(kind=dp), parameter :: N_orbit = 60.50_dp !Number of orbits to integrate. Used if duration = 'long' (below)
real(kind=dp), parameter :: N_spins = 3.0_dp !Number of spin periods to integrate. Used if duration = 'short' (below)
...
real(kind=dp), parameter :: stheta = PI/4.0_dp, sphi = 0.0_dp !Initial oreintatin of spin axis
...
character(len=20), parameter :: duration = 'long' !long, short. Long integrates for Norbits * period. !Short integrates for 
